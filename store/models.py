...
class Product(models.Model):
    ...
    # Campos nuevos de la fase Gengar
...
class Order(models.Model):
    # Estados del Pedido (Para Webpay)
    STATUS_CHOICES = [
        ('PENDING', 'Pendiente de Pago'),
        ('PAID', 'Pagado Exitosamente'),
        ('REJECTED', 'Rechazado/Anulado'),
    ]

    # --- CAMPOS ORIGINALES (Los que te faltaban) ---
    name = models.CharField(max_length=100)
    ...
    # --- CAMPOS NUEVOS (Webpay) ---
    status = models.CharField(max_length=10, choices=STATUS_CHOICES, default='PENDING')
    webpay_token = models.CharField(max_length=100, blank=True, null=True) 
